...
public class SocialCombo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.socialfragments, container, false);
        ...
        adapter.addfragment(new InstagramFrag(), "Instagram");
        adapter.addfragment(new FacebookFrag(), "Facebook");
