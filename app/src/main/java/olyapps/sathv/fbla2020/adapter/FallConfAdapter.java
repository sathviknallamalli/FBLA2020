...
public class FallConfAdapter extends ArrayAdapter<FallConfDataModel> {

    List<FallConfDataModel> modelList;
    private LayoutInflater mInflater;

    // Constructors
    public FallConfAdapter(Context context, List<FallConfDataModel> objects) {
    ...
    @Override
    public FallConfDataModel getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        FallConfDataModel item = getItem(position);
